  ...
  const reasons = [
    {
      ...
      desc: "Struggling with reading, writing, or understanding information at school or work.",
    },
    {
      title: "Focus and Organization",
      desc: "Difficulty concentrating, staying organized, or completing tasks.",
    },
    {
      title: "Emotional & Learning Balance",
      desc: "Challenges that affect confidence, motivation, or daily learning experiences.",
    },
    {
      title: "Academic Growth Support",
      desc: "When effort does not seem to match results — we help bring clarity and practical next steps.",
    },
  ];
  ...
  const evaluationSteps = [
    {
      ...
      desc: "We begin with a relaxed conversation. We talk about your experiences, school background, and the specific areas where support is needed.",
    },
    {
      icon: BookOpen,
      phase: "Phase 2",
      title: "Interactive Activities",
      desc: "We use structured play-style activities, reading exercises, puzzles, and everyday tasks. This helps us understand how you or your child learns best.",
    },
    {
      icon: Award,
      phase: "Phase 3",
      title: "Results and Next Steps",
      desc: "We sit together to review a clear, easy-to-follow guide. You will leave with practical ideas for school support and daily strategies.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1]">
              Learning Support <br />
              <span className="text-[#67E8D6]">Sessions in Dallas.</span>
            </h1>

            <p className="text-base sm:text-lg text-slate-300 max-w-xl font-normal leading-relaxed">
              Discover how you or your child learns best. We offer welcoming,
              thoughtful learning support sessions to bring clarity and
            ...
            >
              <div className="w-full h-full p-6 flex flex-col justify-end text-white">
                ...
                <p className="font-bold text-base leading-snug">
                  Designed completely for your personal pace.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="bg-white border border-slate-200/80 rounded-[2.5rem] p-8 sm:p-12 shadow-sm grid md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-5 space-y-3">
            ...
            <p className="text-3xl font-bold text-[#023B37] tracking-tight">
              What is a Learning Support Session?
            </p>
          </div>
          <div className="md:col-span-7 space-y-4">
            <p className="text-slate-600 font-normal text-base leading-relaxed">
              At Ariad Support Services, we offer thoughtful learning support
              sessions in Dallas. These help children, teens, and adults better
              understand their unique learning style, strengths, and areas for
              growth.
            </p>
            <p className="text-slate-600 font-normal text-base leading-relaxed">
              Whether you're navigating reading challenges, focus differences,
              or simply want more clarity on how to thrive in school or daily
              life, our local team is here to help families across Uptown,
              Lakewood, and Highland Park.
            </p>
          </div>
        </div>
      </div>
          ...
          {[
            {
              ...
              desc: "Our neighborhood guides bring practical insight into the learning needs of Dallas families and schools.",
            },
            {
              icon: BookOpen,
              title: "Personalized Guidance",
              desc: "We create custom support plans based on your unique story and experiences.",
            },
            {
              icon: MapPin,
              title: "Serving Local Communities",
              desc: "Convenient support for families across Dallas, Uptown, Lakewood, Highland Park, and surrounding areas.",
            },
            {
              icon: ShieldCheck,
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 bg-[#012321] rounded-[2.5rem] p-8 sm:p-12 min-h-[320px] flex flex-col justify-between border border-white/5 relative shadow-inner">
              ...
              <div className="flex gap-2 mt-8 pt-4 border-t border-white/10 text-xs text-slate-400 font-medium">
                ...
                <span>Personalized • Confidential • Supportive</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-3xl sm:text-4xl font-bold text-[#023B37] tracking-tight">
            Reasons families seek learning support
          </p>
        </div>
        ...
        >
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-base sm:text-lg text-slate-300 font-normal leading-relaxed max-w-xl mx-auto">
              Our team is ready to help you better understand learning strengths
              and create positive next steps. Reach out today.
            </p>
            <div className="pt-2">
              <a
                href="/contact"
