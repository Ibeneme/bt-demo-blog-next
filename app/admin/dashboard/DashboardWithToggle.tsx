          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-8 shadow-2xl">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-4 border border-stone-300 rounded-2xl hover:bg-stone-50 font-medium transition-colors"
              >
                Cancel
              </button>
              <button
                ...
                disabled={!!deletingId}
                className="flex-1 py-4 bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white rounded-2xl font-semibold transition-colors flex items-center justify-center gap-2"
              >
                {deletingId ? (
                  <>
            ...
            <p className="text-center text-[10px] text-stone-400 mt-6">
              This will permanently remove the article and its associated images
            </p>
          </div>
        </div>
      )}
