...
export default function BlogEditClient({ slug }: { slug: string }) {
  ...
  const generateStructuredData = (data: typeof formData): string => {
    ...
    const articleUrl = data.canonicalUrl || `${baseUrl}/blog/${slug}`;
    const structured = {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let finalOgUrl = article.og_image_url;

      if (image) finalImageUrl = await uploadImage(image, "featured");
      if (ogImage) finalOgUrl = await uploadImage(ogImage, "og");
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div
                  ...
                  data-placeholder="Edit your article content here..."
                  className="rich-content-editor w-full min-h-[450px] p-6 bg-white rounded-2xl border border-slate-200 outline-none focus:border-[#067F76] text-base leading-relaxed"
